...
3. Fill out the term form (`term`, `definition`, `explanation`, and optional fields).
4. Submit to call `POST /api/terms`.
5. The term is appended to `/data/terms.json` with generated `slug` + `createdAt` timestamp.
